...
public final class Formatter {
    ...
    /** Formats the given digest bytes to a hexadecimal
     * String.
     * @param digest the digest bytes to format.
     * @return the digest bytes formatted as hexadecimal
     * String. Every byte is formatted as two characters.
     * */
