...
/**
 * Test cases that compare the message digest of the Sun provider (aka 'reference') with the
 * implementations in this context (aka 'test').
 *
...
public class MessageDigestWithReferenceMDTest extends BaseTest {
  ...
  private void applyTo(
      Consumer<MessageDigest> consumer, MessageDigest testMD, MessageDigest referenceMD) {
  ...
  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithFullArray(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
    applyTo(md -> md.update(franzJagt()), testMD, referenceMD);
  }

  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithSingleBytes(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
    applyTo(
        md -> {
  ...
  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithHeapByteBuffer(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
  ...
  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithReadOnlyHeapByteBuffer(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
    final List<ByteBuffer> list = new ArrayList<>();
    applyTo(
        md -> {
  ...
  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithReadOnlyMiddlePositionHeapByteBuffer(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
    final List<ByteBuffer> list = new ArrayList<>();
    applyTo(
        md -> {
  ...
  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithDirectByteBufferNoRemaining(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
    final List<ByteBuffer> list = new ArrayList<>();
    applyTo(
        md -> {
  ...
  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithDirectByteBuffer(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
    final List<ByteBuffer> list = new ArrayList<>();
    applyTo(
        md -> {
  ...
  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithNonFullDirectByteBuffer(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
    final List<ByteBuffer> list = new ArrayList<>();
    applyTo(
        md -> {
  ...
  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithMiddlePositionDirectByteBuffer(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
    final List<ByteBuffer> list = new ArrayList<>();
    applyTo(
        md -> {
  ...
  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithFragmentedArray(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
    applyTo(
        md -> {
  ...
  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithLongArray(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
    applyTo(
        md -> {
  ...
  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithLongDirectBB(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
    applyTo(
        md -> {
          byte[] data = filledArray(1024 * 1024);
  ...
  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithDirectBBWalkingPosition(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
    int size = 10240;
  ...
  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithHeapBBWalkingPosition(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
    int size = 10240;
    for (int i = 0; i < size; i++) {
      final int position = i;
  ...
  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithReadOnlyBBWalkingPosition(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
    int size = 10240;
    for (int i = 0; i < size; i++) {
      final int position = i;
  ...
  @ParameterizedTest
  @MethodSource("provideTestArguments")
  public void updateWithArrayWalkingPosition(
      String digestName, MessageDigest testMD, MessageDigest referenceMD) {
    int size = 10240;
    for (int i = 0; i < size; i++) {
      final int position = i;
