...
/**
 * Test cases that compare the message digest of the implementations with well known expected
 * outputs.
 *
...
public class MessageDigestWithKnownHashesTest extends BaseTest {
  ...
  public void compareWithWellKnownHash(
      String digestName, MessageDigest testMD, byte[] clearText, String expectedDigest) {
