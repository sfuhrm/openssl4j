...
public class MessageDigestWithKnownHashesTest extends BaseTest {
    ...
    private static final String[] REFERENCES = new String[] { "BLAKE2b512", "",
            "786a02f742015903c6c6fd852552d272912f4740e15847618a86e217f71f5419d25e1031afee585313896444934eb04b903a685b1448b755d56f701afe9be2ce",
            "BLAKE2b512", "The quick brown fox jumps over the lazy dog",
            "a8add4bdddfd93e4877d2746e62817b116364a1fa7bc148d95090bc7333b3673f82401cf7aa2e4cb1ecd90296e3f14cb5413f8ed77be73045b13914cdcd6a918",
            "BLAKE2b512", "The quick brown fox jumps over the lazy dof",
            ...
            "BLAKE2b512", "",
            "786a02f742015903c6c6fd852552d272912f4740e15847618a86e217f71f5419d25e1031afee585313896444934eb04b903a685b1448b755d56f701afe9be2ce",
            "BLAKE2s256", "", "69217a3079908094e11121d042354a7c1f55b6482ca1a51e1b250dfd1ed0eef9", "RIPEMD160", "",
            "9c1185a5c5e9fc54612808977ee8f548b2258d31", "RIPEMD160", "The quick brown fox jumps over the lazy dog",
            "37f332f68db77bd9d7edd4969571ad671cf9dd3b", "RIPEMD160", "The quick brown fox jumps over the lazy cog",
            "132072df690933835eb8b6ad0b77e7b6f14acad7", "MD4", "", "31d6cfe0d16ae931b73c59d7e0c089c0", "MD4",
    ...
    private static Stream<Arguments> provideTestArguments() throws NoSuchAlgorithmException, IOException {
        ...
        for (int i = 0; i < REFERENCES.length; i += 3) {
            ...
            result.add(Arguments.of(algorithm, MessageDigest.getInstance(algorithm, openSsl),
                    clearText.getBytes(StandardCharsets.US_ASCII), expected));
        }
    ...
    public void compareWithWellKnownHash(String digestName, MessageDigest testMD, byte[] clearText,
