...
public final class Formatter {
     ...
     *
     * @param digest
     *            the digest bytes to format.
     *
     * @return the digest bytes formatted as hexadecimal String. Every byte is formatted as two characters.
     */
     ...
     *
     * @param b
     *            a nibble value between 0 and 15 (inclusive).
     *
     * @return the character value.
     *
     * @throws IllegalArgumentException
     *             if the character was not inside the hex chars.
     */
