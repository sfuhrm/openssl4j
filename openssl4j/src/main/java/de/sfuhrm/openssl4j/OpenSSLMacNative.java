...
public class OpenSSLMacNative extends MacSpi {
    ...
    private static native int hmacNative(long libCtx, String algName, byte[] key, int keyLen, byte[] data, int dataLen,
            byte[] output);
    ...
    protected byte[] engineDoFinal() {
        ...
        int respSize = hmacNative(OpenSSLCryptoNative.getLibInstance(), curAlgorithim, encodedKey, encodedKey.length,
                buffer, buffer.length, resp);
